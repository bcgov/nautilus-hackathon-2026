...
values (1, 1, 'nautilus-main', 1, '2026-01-20T10:05:00Z', '2026-01-20T10:05:00Z');

insert into pipeline (id, repository_id, name, auto_deploy, created_at, updated_at)
values (2, 1, 'nautilus-release', 0, '2026-01-20T10:06:00Z', '2026-01-20T10:06:00Z');

insert into pipeline (id, repository_id, name, auto_deploy, created_at, updated_at)
values (3, 2, 'harbor-main', 1, '2026-01-20T10:07:00Z', '2026-01-20T10:07:00Z');
